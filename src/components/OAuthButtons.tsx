    ...
    <div className="mt-8">
      ...
      <div className="flex justify-center gap-6">
        ...
        <button
          ...
          disabled={loading !== null}
          className="w-14 h-14 bg-black border border-white/20 rounded-full flex items-center justify-center hover:scale-110 active:scale-95 transition-transform disabled:opacity-50 disabled:hover:scale-100 shadow-lg"
          aria-label="Continue with Apple"
        >
          {loading === 'apple' ? (
            <div className="w-6 h-6 border-2 border-white border-t-transparent rounded-full animate-spin" />
          ) : (
            <svg className="w-7 h-7 mb-1" viewBox="0 0 24 24" fill="white">
