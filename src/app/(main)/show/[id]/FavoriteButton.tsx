...
import { toggleFavoriteShow } from './actions'

export function FavoriteButton({ showId, isFavorite }: { showId: number, isFavorite: boolean }) {
  const [isPending, startTransition] = useTransition()

  const handleToggle = () => {
    startTransition(async () => {
      await toggleFavoriteShow(showId, !isFavorite)
    })
  }
